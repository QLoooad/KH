...
public class Emp {
	...
	public Emp(String departmentTitle, int peopleNum, int salary) {
		super();
		this.salary = salary;
	...
	public Emp(int empId, String empName, String departmentTitle, String jobName, int salary, String phone, String email
			) {
		super();
		this.empId = empId;
		this.empName = empName;
	...
	public Emp(int empId, String empName, String departmentTitle, String jobName, int salary, 
			String phone, String email, Date hireDate, String entYN) {
		super();
		this.empId = empId;
		this.empName = empName;
		this.email = email;
