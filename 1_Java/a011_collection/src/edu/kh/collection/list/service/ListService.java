...
//		ArrayList list = new ArrayList();	//기본 생성자 > 10칸짜리
		ArrayList list = new ArrayList(3);	//매개변수 생성자 > 3칸짜리
		
		//예상되는 데이터 수에 따라 생성자를 골라서 사용
		//생성자에 따라 속도, 메모리 효율이 달라짐
		
		//boolean add(E e) : 리스트 마지막에 추가
...
//		list.add(10, "삽입");	//오류발생
		...
		//E get(int index) : 주어진 index의 요소 반환
	...
	public void ex2() {
		...
		//String으로 타입이 제한된 ArrayList객체 생성해 부모타입인 list참조
		//컴파일 단계에서 타입 체크
		//컬렉션에 사용되는 객체의 타입이
