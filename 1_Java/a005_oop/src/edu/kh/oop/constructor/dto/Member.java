...
public class Member {
	...
	/*    생성자 : 객체를 생성하는 기능
	 * 생성자 작성규칙
	 * 1. 반환형 (voin, int, String....)dl djqtek
	 * 2. 생성자명은 클래스와 동일
	*/
	...
	public Member() { //기본 생성자
						// -() 안에 아무것도 없음
		/////////////////////////////////////////////////////
		//>>>>>>>>>>>클내스 내에 아무런 생성자도 작성되지 않은 경우 <<<<<<<<<
		//컴파일러가 자동으로 기본 생성자 추가해준다
		//
		//	public Member(){}
		//	
		//	단, 기본 생성자만 없고
		//다른 매개변수 생성자가 존재하면
        //컴파일러는 자동으로 기본생성자를 추가하지 않는다
		/////////////////////////////////////////////////////
		//객체 생성 시 특정 기능 수행
	...
	public Member(String memberId) {
		this(); // 현재 클래스의 기본 생성자 호출( ctrl 누르고 this 클릭)
		// >>this생성자
		//코드길이 감소를 위해 사용
		this.memberId = memberId;
	} //성립
