...
--					해당 컬럼의 값을 작성하지 않거나
--					DEFAULT로 작성 시 
--					DEFAULT 오른쪽에 작선된 값이 컬럼에 반영

-- 만든 테이블 확인
SELECT * FROM MEMBER;

SELECT * FROM USER_TABLES;
	--> 딕셔너리 뷰(데이터 딕셔너리에서 일부만 뽑아 보여주는 가상테이블)
...
INSERT INTO "MEMBER" 
VALUES('MEM03', 'QWERASDF', '박철수', '950505-2345678', DEFAULT);

SELECT * FROM MEMBER;
-- 가입일 -> INSERT 시 미작성 하는 경우 -> DEAFULT 값이 반영됨
INSERT INTO "MEMBER"  (MEMBER_ID, MEMBER_PW, MEMBER_NAME, MEMBER_SSN)
VALUES('MEM04', '12341234', '이지연', '001010-4234567');


--  데이터  삽입 확인
SELECT * FROM MEMBER;

COMMIT; --> TCL 트랜젝션에 저장된 DML 구문을 DB에 반영

ROLLBACK; --> 마지막 COMMIT 상태로 돌아감(트랜잭션 DML 삭제)
...
-- ORA-01400: NULL을 ("KH_CGT"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_CGT.SYS_C007464)에 위배됩니다
-- ORA-00001: 무결성 제약 조건(KH_CGT.USER_ID_UK)에 위배됩니다
...
CREATE TABLE USER_USED_UK2(
    ...
    -- 테이블 레벨 복합키 지정
    , CONSTRAINTS USER_ID_NAME_UK UNIQUE(USER_ID, USER_NAME)
);
...
-->  USER_ID VARCHAR2(20) UNIQUE 중복으로 오류
...
-- ORA-01400: NULL을 ("KH_CGT"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
--> 복합키로 PK가 설정되어 있어도
--  결국은 PK == NULL 삽입 불가능
----------------------------------------------------------------------------------------------------------------
...
--> NULL 사용 가능. (외부 테이블에 참조할 값이 없다, 참조 X)
...
-- ORA-02291: 무결성 제약조건(KH_CGT.GRADE_CODE_FK1)이 위배되었습니다- ***부모 키가 없습니다***
-- 부모(GRADE_CODE)에 50이라는 값이 없다
...
WHERE GRADE_CODE = 20;
--> GRADE_CODE = 20 은 자식 테이블에서 참조하고 있지 않으므로 
--	삭제가 제한되지 않는다

-- 참조를 하고 있는 GRADE_CODE = 10 삭제
DELETE FROM USER_GRADE
WHERE GRADE_CODE = 10;
...
VALUES (1, 'user01', 'pass01', '880122-1234567', '남', '010-1111-9999', '서울시 강남구 역삼동', DEFAULT);

INSERT INTO USER_TEST
VALUES (2, 'user02', 'pass02', '890222-2234567', '여', '010-2222-9999', '서울시 강남구 삼성동', 'Y');

INSERT INTO USER_TEST
VALUES (3, 'user03', 'pass03', '900322-2234567', '여', '010-3333-9999', '서울시 강남구 청담동', 'Y');

INSERT INTO USER_TEST
VALUES (4, 'user04', 'pass04', '910422-1234567', '여', '010-4444-9999', '서울시 강남구 도곡동', DEFAULT);

INSERT INTO USER_TEST
VALUES (5, 'user06', 'pass05', '920522-2234567', '여', '010-5555-9999', '서울시 강남구 대치동', 'N');

INSERT INTO USER_TEST
VALUES (6, 'user07', 'pass05', '980503-2234567', '남', '010-5555-9999', '서울시 강남구 대치동', 'Y');

INSERT INTO USER_TEST
VALUES (7, 'user08', 'pass05', '970623-2234567', '남', '010-5555-9999', '서울시 강남구 대치동', 'N');

INSERT INTO USER_TEST
VALUES (8, 'user09', 'pass05', '791231-2234567', '여', '010-5555-9999', '서울시 강남구 대치동', 'Y');
