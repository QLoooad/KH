// 계산 버튼 클릭 시
// input 태그에 작성된 값을 모두 읽어와 합한 결과를 alert 로 출력
...
document.getElementById("add").addEventListener("click", ()=>{
    ...
    // 요소에 속성, 값 제거 : 요소.removeAttribute("속성명");

    // 부모요소.append(자식요소) : 부모 요소의 마지막 자식으로 자식 요소를 추가(덧붙이기)

    // 부모요소.prepend(자식요소) : 부모 요소의 첫 번째 자식으로 자식 요소를 추가(덧붙이기)
    ...
    // span에 &times; 내용 추가 (innerHTML)
    span.innerHTML = "&times;";
    
    // 만들어진 span 요소에 이벤트 리스터 추가
...
// class가 remove-row인 요소 중 첫 번째 요소
