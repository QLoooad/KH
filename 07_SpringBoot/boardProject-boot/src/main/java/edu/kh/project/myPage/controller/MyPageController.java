...
public class MyPageController {
	...
	@Autowired // MyPageService의 자식 MyPageServiceImpl의 의존성 주입(DI)
	...
	public String updateInfo(Member updateMember, String[] memberAddress,
		...
		// -> session에서 얻어온 loginMember에 해당하는 객체를
	 ...
	 * 
	 * [제공하는 메서드] - transferTo() : 파일을 지정된 경로에 저장(메모리 > hdd/ssd) -
	 * getOriginalFileName() : 파일 원본명 - getSize() : 파일 크기
	 * 
	 */
